...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="#intrest" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Intresseanmälan</a>
...
--->
  ...
  <div class="w3-container" id="contact" style="margin-top:75px">
    ...
    <form action="<? $_SERVER['PHP_SELF']; ?>" method="post">
      ...
      <div class="w3-section">
        <label>Adress*</label>
        <input class="w3-input w3-border" type="text" name="address" value="<?= $address ?>" tabindex="2">
        <span class="error"><?= $address_error ?></span>
      </div>
      <div class="w3-section">
        <label>Email*</label>
        <input class="w3-input w3-border" type="text" name="email" value="<?= $email ?>" tabindex="3">
        <span class="error"><?= $email_error ?></span>
      </div>
      <div class="w3-section">
        <label>Telefonnummer*</label>
        <input class="w3-input w3-border" type="text" name="phone" value="<?= $phone ?>" tabindex="4">
        <span class="error"><?= $phone_error ?></span>
      </div>
      <div class="w3-section">
        <label>Husdjur</label>
        <input class="w3-input w3-border" type="text" name="pet" value="<?= $pet ?>" tabindex="5">
      </div>
      ...
      <div class="w3-section">
        ...
        <input class="w3-input w3-border" type="text" name="message" value="<?= $message ?>" tabindex="6">
      </div>
